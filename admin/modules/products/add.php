...
// Khai báo biến
$pro_create_time      = time();
$pro_update_time      = time();
$pro_picture_json     = "";
$pro_name            = "";
$pro_picture          = "";
$pro_category_id      = 0;
...
if($record_id > 0){
	...
	$db_data 	= new db_query("SELECT * FROM " . $fs_table . " WHERE pro_id = " . $record_id);
...
$myform->add("pro_mil", "pro_mil", 3, 0, 0, 0, "", 0, "");
...
$myform->add("pro_create_time", "pro_create_time", 1, 1, 0, 0, "", 0, "");
$myform->add("pro_update_time", "pro_update_time", 1, 1, 0, 0, "", 0, "");
$myform->add("pro_active", "pro_active", 1, 0, 0, 0, "", 0, "");
$myform->add("pro_hot", "pro_hot", 1, 0, 0, 0, "", 0, "");
$myform->add("pro_sale", "pro_sale", 1, 0, 0, 0, "", 0, "");
...
if($action == "execute"){
	...
	if($fs_errorMsg == ""){
		...
		if($record_id > 0){
			...
			$db_update = new db_execute($myform->generate_update_SQL("pro_id", $record_id));
			unset($db_update);
...
<div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
	...
	<div class="tab-content" id="myTabContent" style="padding-top: 20px;">
		<div class="tab-pane fade active in" role="tabpanel" id="home" aria-labelledby="home-tab">
			...
			<?
			$old_price_text			= ($pro_mil > 0 ? '<span style="color: red; font-style: italic;" id="old_price_text">' . format_number($pro_mil) . '</span>' : '<span style="color: red; font-style: italic;" id="old_price_text"></span>');
			?>
			<?=$form->text("Diện tích", "pro_mil", "pro_mil", $pro_mil, "Giá", 0, 150, "", 30, "", 'autocomplete="off" onkeyup="changePriceText(\'old_price_text\', this.value)"', ' m2 ' . $old_price_text)?>
