...
$list->add("ctt_phone", translate_text("Điện thoại"), "text", 0, 1);
$list->add("ctt_city_id", translate_text("Thành phố"), "arraytext", 0, 0);
$list->add("ctt_email", translate_text("Email"), "text", 0, 1);
$list->add("ctt_message", translate_text("Nội dung"), "text", 0, 0);
$list->add("ctt_khoahoc_id", translate_text("Khóa học"), "arraytext", 0, 0);
$list->add("ctt_date", "Ngày tạo", "date", 1, 0);
