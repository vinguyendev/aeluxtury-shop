...
$add					= "add.php";
$listing				= "listing.php";
$fs_title			= "Thêm mới nhóm màu sắc";
$fs_action			= getURL();
$fs_redirect		= $after_save_data;
$fs_errorMsg		= "";
$cog_create_time			= time();
...
$myform->add("cog_create_time", "cog_create_time", 1, 1, 0, 0, "", 0, "");
...
<? /*------------------------------------------------------------------------------------------------*/ ?>
	<p align="center" style="padding-left:10px;">
		...
		<?=$form->text("Tên nhóm", "cog_name", "cog_name", $cog_name, "Tên nhóm", 1, 250, "", 255, "", "", "")?>
		<?=$form->text("Màu đại diện", "cog_color", "cog_color", $cog_color, "Màu đại diện", 1, 250, "", 255, "", "", "")?>
		<?=$form->text("Thứ tự", "cog_order", "cog_order", $cog_order, "Thứ tự", 1, 250, "", 255, "", "", "")?>
		<?=$form->getFile("Ảnh minh họa", "cog_picture", "cog_picture", "Ảnh minh họa", 0, 32, "", '<br />(Dung lượng tối đa <font color="#FF0000">' . $fs_filesize . ' Kb</font>)');?>
		<?=$form->textarea("Mô tả ngắn", "cog_short_description", "cog_short_description", $cog_short_description, "Mô tả ngắn", 0, 450, 250, "", "", "")?>
