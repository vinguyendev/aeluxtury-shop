...
$myform->add("sup_name", "sup_name", 0, 0, " ", 1, "Bạn chưa nhập tên nhãn hiệu.", 1, "Nhãn hiệu này đã tồn tại");
...
$myform->add("sup_create_time", "sup_create_time", 1, 1, 0, 0, "", 0, "");
