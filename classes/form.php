...
class form{
	...
	var $class_table					= 'table table_border_none';		// Style của table
	var $class_form					= '';				// Style của form
	var $class_form_button			= 'btn btn-primary btn-sm';		// Style của button control
	...
	*/
	...
	8. $height			: Chiều cao của textarea			(Exp: "100" px)
	*/
	function wysiwyg($titleControl, $id, $value, $basePath='../ckeditor/', $width='100%', $height='450'){
		...
		echo '<div class="' . $this->class_form_name . '" style="text-align:left; padding:5px; height:' . $height . '; width:' . $width . '">' . $titleControl . '</div>';
		//$oFCKeditor->Create();
