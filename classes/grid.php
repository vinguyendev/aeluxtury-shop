	...
	*/
	...
	function footer(){
		...
		if($this->delete_all){
			...
			$str .= '<td width="150">';
			$str .= '<a class="btn-sm btn-danger" href="#" onclick="if (confirm(\''  . str_replace("'","\'",translate_text("Do you want to delete the product you selected ?"))  . '\')){ deleteall(' . $this->total_list . '); }">' . translate_text("Delete all selected") . '</a>';
			$str .= '</td>';
			$str .= '<td width="150">';
