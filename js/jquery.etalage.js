...
(function($){
	$.fn.etalage = function(options){
		...
		var o = $.extend({
			...
			thumb_image_width: 600,				// The large thumbnail width (excluding borders / padding) (value in pixels)
			thumb_image_height: 400,			// The large thumbnail height (excluding borders / padding) (value in pixels)
			source_image_width: 600,			// The source/zoomed image width (not the frame around it) (value in pixels)
			source_image_height: 400,			// The source/zoomed image height (not the frame around it) (value in pixels)
			zoom_area_width: 500,				// Width of the zoomed image frame (including borders, padding) (value in pixels)
			zoom_area_height: '400',		// Height of the zoomed image frame (including borders, padding) (value in pixels / 'justify' = height of large thumb + small thumbs)
